...
Blockly.Arduino.linkit_wifi_wait_until_ready=function(){
	...
	Blockly.Arduino.definitions_.define_linkit_wifi_ssid='static char ssid[] = '+a+';';
	Blockly.Arduino.definitions_.define_linkit_wifi_pass='static char pass[] = '+b+';';
	Blockly.Arduino.definitions_.define_linkit_wifi_status='static int status = WL_IDLE_STATUS;';     // Indicator of Wifi status

	return"while (status != WL_CONNECTED)\n{\n\t\tstatus = WiFi.begin(ssid, pass);\n\t\tdelay(1000);\n}\n"
};
