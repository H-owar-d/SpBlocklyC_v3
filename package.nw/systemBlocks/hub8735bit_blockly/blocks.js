...
Blockly.Blocks['amb82_mini_video_initial'] = {
  init: function() {
    ...
    this.appendDummyInput()
		...
		.appendField(new Blockly.FieldDropdown([
			["FHD (1920กั1080)","VIDEO_FHD"],
			["HD (1280กั720)","VIDEO_HD"],
			["D1 (720กั480)","VIDEO_D1"],
			["VGA (640กั480)","VIDEO_VGA"],
			["WVGA (640กั360)","VIDEO_WVGA"],
			["QVGA (320กั240)","VIDEO_QVGA"],
			["QCIF (176กั144)","VIDEO_QCIF"],
...
Blockly.Blocks['amb82_mini_myfirmata'] = {
  init: function() {
	...
	this.appendDummyInput()
		...
		.appendField(new Blockly.FieldDropdown([
			//["2K (2560กั1440)","VIDEO_2K"],
			//["5M (2448กั2050)","VIDEO_5M"], 
			//["3M (2048กั1536)","VIDEO_3M"],
			["FHD (1920กั1080)","VIDEO_FHD"],
			["HD (1280กั720)","VIDEO_HD"],
			["D1 (720กั480)","VIDEO_D1"],
			["VGA (640กั480)","VIDEO_VGA"],
